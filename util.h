...
typedef struct CPU_State_Struct {
    ...
    //TEMP_STALL
	uint32_t IF_TEMP_STALL;
	uint32_t ID_TEMP_STALL;
	uint32_t EX_TEMP_STALL;
	uint32_t MEM_TEMP_STALL;
	uint32_t WB_TEMP_STALL;

	//Flush
	uint32_t IF_FLUSH;
	uint32_t PC_WRITE;
	uint32_t PC_SRC; // 0 -> origin, 1 -> target
	uint32_t ID_BR_TAKE;
	uint32_t JUMP;
	...
	uint32_t ID_EX_REG1;
	uint32_t ID_EX_REG2;
	uint32_t ID_EX_REG1V;
	uint32_t ID_EX_REG2V;
	uint32_t ID_EX_DESTV;
	uint32_t ID_EX_TARGET;
	short ID_EX_IMM;
	unsigned char ID_EX_SHAMT;
	unsigned char ID_EX_DEST;

	//ID_EX_latch Control Signal
	uint32_t ID_EX_REG_DST;
	uint32_t ID_EX_ALU_SRC;
	uint32_t ID_EX_BRCH;
	uint32_t ID_EX_MEM_READ;
	uint32_t ID_EX_MEM_WRITE;
	uint32_t ID_EX_REG_WRITE;
	uint32_t ID_EX_MEM_TO_REG;
	...
	uint32_t EX_MEM_JUMP;
	uint32_t EX_MEM_DESTV;
	unsigned char EX_MEM_DEST;
	unsigned char EX_MEM_REG2;
	short EX_MEM_IMM;
	short EX_MEM_OPCODE;
	short EX_MEM_FUNCT;
	
	//EX_MEM latch Control Signal
	uint32_t EX_MEM_BRCH;
	uint32_t EX_MEM_MEM_READ;
	uint32_t EX_MEM_MEM_WRITE;
	uint32_t EX_MEM_REG_WRITE;
	uint32_t EX_MEM_MEM_TO_REG;
	...
	//MEM_EX latch Control Signal
	uint32_t MEM_WB_REG_WRITE;
	uint32_t MEM_WB_MEM_TO_REG;


	//Forwarding
	unsigned char ID_EX_FORWARD_REG1;
	unsigned char ID_EX_FORWARD_REG2;
	unsigned char EX_FORWARD_REG1;
	unsigned char EX_FORWARD_REG2;
	unsigned char MEM_WB_FORWARD_COPY;
